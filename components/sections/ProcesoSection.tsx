          ...
          <div className="flex flex-col justify-center">
            {steps.map(({ number, icon: Icon, title, tag, description }, idx) => (
              <div key={number} className="relative flex gap-5 pb-10 last:pb-0">
                ...
                <div className="relative z-10 flex h-11 w-11 flex-shrink-0 items-center justify-center rounded-md bg-cc-accent-light">
                  <Icon size={20} className="text-cc-accent" aria-hidden="true" />
                </div>

                <div className="pt-1">
                  <div className="mb-1.5 flex flex-wrap items-center gap-2">
                    <span className="text-[12px] font-display font-medium text-cc-accent/40">
                      {number}
                    </span>
                    ...
                    {tag && (
                      <span className="rounded-full bg-cc-accent-light px-2 py-0.5 text-[11px] font-medium text-cc-accent">
                        {tag}
                      </span>
                    )}
                  </div>
