...
> Documento histórico de 2025: describe una estructura de home y un sistema de animaciones que ya no son los del sitio. Nada de acá describe la implementación actual.
